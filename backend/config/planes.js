export const PLANES = {
  gratis: {
    ...
    limites: { lotes: 0, servicios: 0, tienda: false, ia: false, metricas: false, destacado: false }
  },
  observador: {
    nombre: "Gratis",
    precio: { mensual: 0, trimestral: 0, anual: 0 },
  ...
  productor: {
    ...
    limites: { lotes: 4, servicios: 4, tienda: false, ia: true, metricas: "basico", destacado: false }
  },
  pro: {
    nombre: "Pro",
    precio: { mensual: 9, trimestral: 23, anual: 81 },
    limites: { lotes: Infinity, servicios: Infinity, tienda: true, ia: true, metricas: "completo", destacado: false }
  },
  empresa: {
    nombre: "Empresa",
    precio: { mensual: 19, trimestral: 49, anual: 169 },
    limites: { lotes: Infinity, servicios: Infinity, tienda: true, ia: true, metricas: "avanzado", destacado: true }
  }
};
